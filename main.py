...
def main(file_name):
"""
submitted on Thu Fab 5
@author: Asaf Harpaz 206016248
...
def cols_or_rows(file_name):
    """the cols_or_rows open the file with (R+) method.
       ...
       meaning it will try making the second letter into a floats (after removing the spaces)
       if theres an error it will call cols_handling else it will call rows_handling."""
